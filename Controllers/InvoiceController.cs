...
public class InvoiceController
{
    ...
    public void ModifyProductFromInvoice(int invoiceId, int productId, int newQuantity)
    {
        _service.ModifyProductQuantityFromInvoice(invoiceId, productId, newQuantity);
    }
